	...
	(3, 'Antena 1', 'Stiri'),
	 (4, 'National Geographic', 'Documentare'),
	 (5, 'Pro TV', 'Stiri si divertisment'),
	 (6, 'Disney Channel', 'Desene animate'),
	 (7, 'Animal Planet', 'Documentare '),
	 (8, 'MTV', 'Muzica'),
	 (9, 'Eurosport', 'Sport'),
	 (10, 'History Channel', 'Documentare'),
	 (11, 'TVR 1', 'Stiri'),
	 (12, 'Cartoon Network', 'Desene animate'),
	 (13, 'Euforia Lifestyle', 'sport'),
	 (14, 'Digi Sport', 'sport'),
	 (15, 'Realitatea Plus', 'Stiri')
	...
	(16, 9, 'Mireasa', 'Romana', '19:00', 90, 'Reality Show', 1000000),
	 ...
	 (23,12,'jimmy','Romana','18:00',100,'Desene animate',45000),
	...
	(35, 12, 'Exatlon', 'Romana', '18:00', 90, 'Desene animate', 600000),
